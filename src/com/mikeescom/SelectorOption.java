...
public class SelectorOption {
    private final IntentBuilderOption option;
    ...
    public IntentBuilderOption getOption() {
        return option;
    }
    ...
    interface IOption{
        ICaption withOption(IntentBuilderOption option);
    }
    ...
    public static final class Builder implements IOption, ICaption, IMnemonic, IBuild{
        private IntentBuilderOption option;
        ...
        public ICaption withOption(final IntentBuilderOption option) {
            this.option = option;
            return this;
        }
